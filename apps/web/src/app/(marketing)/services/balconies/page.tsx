...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/services/balconies' },
}
    ...
    <MarketingShell pathname="/services/balconies">
      <section className="mx-auto max-w-7xl border-l-4 border-primary px-4 py-10 md:px-8 md:py-16">
        ...
        <h1 className="mt-3 font-heading text-4xl font-black uppercase leading-[0.9] sm:text-5xl md:text-8xl">
          Metal &amp; Glass
          <br />
          <span className="text-primary">Balconies</span>
        </h1>
        ...
        <div className="relative aspect-[21/6] overflow-hidden border border-zinc-200 bg-paper">
          ...
          <div className="absolute inset-0 flex items-end p-6 md:p-10">
            <p className="font-heading text-2xl font-black uppercase text-white md:text-3xl">
              Structure first.<br />
              <span className="text-primary">Finish second.</span>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 md:px-8 md:pb-20">
        ...
        <h2 className="mb-10 font-heading text-4xl font-black uppercase md:text-5xl">Frames, decks and guards</h2>
      ...
      <section className="bg-canvas py-16 md:py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          ...
          <h2 className="mb-10 font-heading text-4xl font-black uppercase md:text-5xl">From structure to finish</h2>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbSchema([
              ...
              { name: 'Metal & Glass Balconies', path: '/services/balconies' },
            ]),
          ),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema({
              name: 'Metal & Glass Balconies',
              description: metadata.description!,
              path: '/services/balconies',
              serviceType: 'Metal and glass balcony fabrication and installation',
              image: OFFICIAL_IMAGES.services.balconies.glass,
            }),
          ),
        }}
      />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            howToSchema({
              name: 'How Steelyes fabricates metal and glass balconies',
              description: metadata.description!,
              path: '/services/balconies',
