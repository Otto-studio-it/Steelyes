...
| **2D silhouette packs** | [`frontend/2d-masters/CATALOG.md`](./frontend/2d-masters/CATALOG.md) + [`catalog.json`](./frontend/2d-masters/catalog.json) — per-gate CAD masters for fast configurator lookup |
