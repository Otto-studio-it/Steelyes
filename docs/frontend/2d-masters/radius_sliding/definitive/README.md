# Radius Sliding — definitive prototypes

Fonte originale: cartella `radius sliding` (export Figma).
Organizzati 2026-08-13 con slug canonici `GATE__radius_sliding__{slug}.svg`.
...
| `composite` | boards orizzontali (prior silhouette) |
...
- `apps/web/public/2d-masters/radius_sliding/silhouettes/{slug}.svg`
- `docs/frontend/2d-masters/radius_sliding/silhouettes/{slug}.svg`
